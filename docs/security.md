...
- Throttling de login: 5 tentativas/min por IP no DRF (`ScopedRateThrottle`) **e** rate limiting adicional no `waf` (`limit_req`, defesa em profundidade) no perfil de produção.
